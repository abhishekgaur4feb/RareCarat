...
public class Signup extends Browser_Invoke{
	...
	public void Signup_TestCase(String fname,String lname,String email,String password) throws InterruptedException, FileNotFoundException, IOException{
